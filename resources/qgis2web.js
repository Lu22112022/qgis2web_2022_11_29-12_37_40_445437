...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [117454.996256, 6085979.525615, 494181.255205, 6350185.596335], maxZoom: 15, minZoom: 5
    })
});


map.getView().fit([117454.996256, 6085979.525615, 494181.255205, 6350185.596335], map.getSize());
